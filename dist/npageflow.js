...
class NModuleNode extends NNode {
    constructor(cfg, process) {
        super(cfg, process);
        this.path = cfg.path;
    }
...
class NParallelNode extends NNode {
    constructor(cfg, process) {
        super(cfg, process);
    }
    run() {
...
class NSequenceNode extends NNode {
    constructor(cfg, process) {
        super(cfg, process);
        this.src = cfg.src;
        this.dst = cfg.dst;
...
class NStartNode extends NNode {
    run() {
...
class NExclusiveNode extends NNode {
    constructor(cfg, process) {
        super(cfg, process);
    }
    run() {
 ...
 * 并行网关
 */
class NInclusiveNode extends NNode {
    constructor(cfg, process) {
        super(cfg, process);
    }
    run() {
...
NPageEngine.processId = 1;
NPageEngine.processMap = new Map();

export { $get, $set, Compiler, CssManager, DefineElement, DefineElementManager, DiffTool, Directive, DirectiveManager, DirectiveType, EModuleState, ENodeType, EventFactory, EventManager, Expression, GlobalCache, Model, ModelManager, Module, ModuleFactory, NCache, NEndNode, NError, NEvent, NExclusiveNode, NFactory, NInclusiveNode, NModuleNode, NNode, NPageEngine, NPageProcess, NParallelNode, NSequenceNode, NStartNode, NodomMessage, NodomMessage_en, NodomMessage_zh, Renderer, Route, Router, Scheduler, Util, VirtualDom, createDirective, createRoute, getmkey, nodom, registModule, request, watch };
//# sourceMappingURL=npageflow.js.map
